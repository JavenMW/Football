...
def grabWeeklyDef():
    ...
    url_2024 = "https://github.com/nflverse/nflverse-data/releases/download/player_stats/player_stats_def_2024.csv"
    # alt_url =  "https://github.com/nflverse/nflverse-data/releases/download/depth_charts/depth_charts_2001.csv"
    ...
    # url = "https://github.com/nflverse/nflverse-data/releases/download/player_stats/player_stats_def_2024.csv" # works when hardcodxed for some reason
    # print(f"Downloading {url}")
    # df = pd.read_csv(url, low_memory=False)
    # df['season'] = year
    # dfs.append(df)
